...
function archi_theme_scripts_styles() {
    ...
    wp_enqueue_script("archi-totop", get_template_directory_uri()."/js/jquery.ui.totop.js",array(),false,true);
    wp_enqueue_script("archi-PageScroll2id", get_template_directory_uri()."/js/jquery.malihu.PageScroll2id.js",array(),false,true);	    
