...
=1.6=
* Fixed issue with forward slashes being added to custom HTML and breaking links and images.
* September 28th 2014

=1.5.7=
* More database columns size reduction as some users are having problems creating the custom about author table.
* Added UTF8 as requested by users.
* July 11th 2013

=1.5.6=
* Embed more debug information when there is a problem adding custom about authors. (only shows debug when a problem occurs)
* Increase size of description box to 2000 characters as requested by users.
* Updating LinkedIn profile prefix from http://www.linkedin.com/in/ to http://www.linkedin.com/
* July 4th 2013
